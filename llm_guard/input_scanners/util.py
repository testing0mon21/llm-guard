...
def get_scanner_by_name(scanner_name: str, scanner_config: dict | None = None) -> Scanner:
    ...
    if scanner_name == "CodeCipherObfuscator":
        return CodeCipherObfuscator(**scanner_config)
    ...
    if scanner_name == "TimeBasedEncryption":
        return TimeBasedEncryption(**scanner_config)
