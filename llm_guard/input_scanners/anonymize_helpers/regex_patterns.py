...
DEFAULT_REGEX_PATTERNS: list[DefaultRegexPatterns | RegexPatternsReuse] = [
    ...
    {
        "expressions": [r"\b\d{2}\s?\d{2}\s?\d{6}\b"],
        "name": "PASSPORT_RU_RE",
        "examples": ["4501 123456", "4501123456"],
        "context": ["паспорт", "серия", "номер"],
        "score": 0.75,
        "languages": ["ru"],
    },
    {
        "expressions": [r"\b\d{10}\b", r"\b\d{12}\b"],
        "name": "INN_RU_RE",
    ...
    {
        "expressions": [r"\b\d{3}-\d{3}-\d{3}\s?\d{2}\b"],
        "name": "SNILS_RE",
    ...
    {
        "expressions": [r"\+7\s?\(?\d{3}\)?\s?\d{3}[-\s]?\d{2}[-\s]?\d{2}"],
        "name": "PHONE_RU_RE",
        "examples": ["+7 (495) 123-45-67", "+74951234567"],
        "context": ["телефон", "mobile", "phone"],
        "score": 0.75,
        "languages": ["ru"],
    },
    {
        "expressions": [r"\b[АВЕКМНОРСТУХABEHMOPCTYX]\d{3}[АВЕКМНОРСТУХABEHMOPCTYX]{2}\d{2,3}\b"],
        "name": "CAR_PLATE_RU_RE",
        "examples": ["А123ВС77"],
        "context": ["номер", "авто", "car"],
        "score": 0.75,
        "languages": ["ru"],
    },
]
